...
namespace NearestNeighborSearch
{
    ...
    //Split a points-Array into two subarrays. It first determine the CuttingDimesion and Cutting-Plane and then split the points-Array into two subarrays (left/right)
    static class KdSplitFunctions
    {
        ...
        //This function is from Sunil Arya and David Mount but it doesn't work. So I use my own Quicksort for MedianSplit
