...
namespace NearestNeighborSearch
{
    ...
    //Sorted array only with Insert. The last element is droped, if Array is full
    class SortedArray<T>
    {
        ...
        //Get the K-th element (not so x-th Inserted) 
        //If the Array is 10 items long and there a 3 Inserted, than float.Maxvalue is returned and not the key-value from one of the 3 items
